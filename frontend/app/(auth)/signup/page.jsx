      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-neutral-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-neutral-700 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-400 mt-2">Join the E‑JUST Store</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="John Doe"
                  className={`block w-full pl-10 pr-4 py-3 bg-neutral-700 border-2 rounded-xl text-white text-sm placeholder-neutral-400
                    focus:outline-none focus:ring-2 focus:ring-[#E62334]/20
                    ${errors.name 
                      ? "border-red-400 focus:border-red-500" 
                      : "border-neutral-600 focus:border-[#E62334]"
                    }`}
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`block w-full pl-10 pr-12 py-3 bg-neutral-700 border-2 rounded-xl text-white text-sm placeholder-neutral-400
                    focus:outline-none focus:ring-2 focus:ring-[#E62334]/20
                    ${errors.password 
                      ? "border-red-400 focus:border-red-500" 
                      : "border-neutral-600 focus:border-[#E62334]"
                ...
                >
                  {showPassword ? (
                    <EyeOff className="h-5 w-5 text-neutral-400 hover:text-white" />
                  ) : (
                    <Eye className="h-5 w-5 text-neutral-400 hover:text-white" />
                  )}
                </button>
              </div>
              {errors.password && (
          ...
          <p className="mt-6 text-center text-sm text-neutral-400">
            ...
            <Link 
              href="/login" 
              className="font-medium text-[#E62334] hover:text-[#ff2a3d] transition-colors"
            >
              Sign in
            </Link>
          </p>
